                  ...
                  <form class="needs-validation" novalidate>
                    ...
                    <div class="form-row">
                      ...
                      <!-- <?php
                            ...
                            $posible = $enlace_actualizar->fecha_nacimiento;
                            // print_r($posible);
                            // echo gettype($posible);
                            // echo "<br/>";
                            // $fecha = (str_replace('-', '/', $posible));
                            // 1994-11-01
                            // echo gettype($fecha);
                            // echo "<br/>";
                            // $posible2 = date("d/m/Y", strtotime($fecha));//este es 
                            // strtotime(str_replace('/', '-', '27/05/1990'));
                            // $posible2 = date("d/m/Y", strtotime('1987/03/12'));


                            // $fecha = (str_replace('-', '/', $enlace_actualizar->fecha_nacimiento));
                            // print_r($fecha);

                            // $posible2 = date("d/m/Y", strtotime((str_replace('-', '/', $enlace_actualizar->fecha_nacimiento))));
                            // print_r($posible2)
