...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <table id="container_id_dcarga_inicial_eliminar" style="display: none;">
      <tbody>
      </tbody>
    </table>
  </section>
                              ...
                              <tbody>
                                <?php foreach ($enlace_actualizar_detalle as $index) : ?>
                                  <tr>
                                    ...
                                    <td><input type='text' value='<?php echo $index->item; ?>' class='form-control' id='item' readonly=''></td>
                                    ...
                                    <td><input type="text" class="form-control" value="<?php echo $index->precio_unitario; ?>" id="precio_unitario_actualizar" readonly></td>
                                    <td><input type="text" class="form-control" value="<?php echo $index->valor_total; ?>" id="valor_total" readonly></td>
                                    <td>
                                      <button type="button" class="btn btn-outline-warning class_actualizar_fila"><span class="far fa-edit"></span></button>
                                      <input type="hidden" name="id_dcarga_inicial_actualizar" id="id_dcarga_inicial_actualizar" value="<?php echo $index->id_dcarga_inicial; ?>">
                                      <input type="hidden" id="ip_actualizar" value="<?php echo $_SERVER['REMOTE_ADDR']; ?>">
                                    </td>
                                    <td>
                                      <button type="button" class="btn btn-outline-danger class_eliminar_detalle"><span class="far fa-trash-alt"></span></button>
                                      <input type="hidden" id="id_dcarga_inicial_eliminar" name="id_dcarga_inicial_eliminar" value="<?php echo $index->id_dcarga_inicial; ?>">
                                    </td>
                                  </tr>
                                <?php endforeach; ?>
                              </tbody>
