...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <table id="container_id_dcotizacion_actualizar" style="display: none;">
      <tbody>
      </tbody>
    </table>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="input-group">
                            ...
                            ?>
                            <input type="date" class="form-control" id="fecha_cotizacion" readonly value="<?php echo $enlace_actualizar_cabecera->fecha_cotizacion; ?>">
                          </div>
                        </div>
                        <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="input-group">
                            <input type="text" class="form-control" id="fecha_vencimiento_validez_oferta" readonly value="<?php echo $enlace_actualizar_cabecera->fecha_vencimiento_validez_oferta; ?>">
                          </div>
                        </div>
                      </div>
                          ...
                          <div class="form-group row">
                            <div class="col-md-6">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="ds_nombre_cliente_proveedor" readonly value="<?php echo $enlace_actualizar_cabecera->ds_nombre_cliente_proveedor; ?>">
                    ...
                    <div class="col-md-12">
                      <div class="form-group row">
                        ...
                        <div class="col-md-1">
                          ...
                          <div class="form-check">
                            <div class="input-group">
                              ...
                              <?php if ($enlace_actualizar_cabecera->categoria == "PRODUCTOS") { ?>
                                <button type="button" class="btn btn-success btn-flat" data-toggle="modal" data-target="#opcion_target_producto" id="btn_id_producto"></button>
                              <?php } else { ?>
                                <button type="button" class="btn btn-success btn-flat" data-toggle="modal" data-target="#opcion_target_producto" id="btn_id_producto" disabled></button>
                              <?php } ?>
                        ...
                        <div class="col-md-1">
                          ...
                          <div class="form-check">
                            <div class="input-group">
                              <?php if ($enlace_actualizar_cabecera->categoria == "TABLEROS") { ?>
                                <button type="button" class="btn btn-success btn-flat" data-toggle="modal" data-target="#opcion_target_tablero" id="btn_id_tablero"></button>
                              <?php } else { ?>
                                <button type="button" class="btn btn-success btn-flat" data-toggle="modal" data-target="#opcion_target_tablero" id="btn_id_tablero" disabled></button>
                              <?php } ?>
                        ...
                        <div class="col-md-2">
                          ...
                          <div class="form-check">
                            <div class="input-group">
                              ...
                              <?php if ($enlace_actualizar_cabecera->categoria == "PRODUCTOS") { ?>
                                <button type="button" class="btn btn-success btn-flat" data-toggle="modal" data-target="#opcion_target_comodin" id="btn_id_comodin"></button>
                              <?php } else { ?>
                                <button type="button" class="btn btn-success btn-flat" data-toggle="modal" data-target="#opcion_target_comodin" id="btn_id_comodin" disabled></button>
                              <?php } ?>
                            ...
                            <select class="form-select select2" id="id_condicion_pago">
                              ...
                              <?php foreach ($cbox_condicion_pago_cotizacion as $cbox_condicion_pago_cotizacion) : ?>
                                <?php if ($cbox_condicion_pago_cotizacion->id_dmultitabla == $enlace_actualizar_cabecera->id_condicion_pago) : ?>
                                  <option value="<?php echo $cbox_condicion_pago_cotizacion->id_dmultitabla ?>" selected><?php echo $cbox_condicion_pago_cotizacion->descripcion; ?></option>
                                <?php else : ?>
                      ...
                      <input type="hidden" id="hidden_categoria" value="<?php echo $enlace_actualizar_cabecera->categoria; ?>">
                    </div>
                            ...
                            <table id="id_table_detalle_cotizacion" style="width: 100%;">
                              ...
                              <tbody>
                                <?php foreach ($enlace_actualizar_detalle as $index) : ?>
                                  <tr>
                                    <input type="hidden" id="id_dcotizacion" value="<?php echo $index->id_dcotizacion; ?>">
                                    <input type="hidden" id="id_general" value="<?php echo $index->id_general; ?>">
