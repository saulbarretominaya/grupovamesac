...
class C_carga_inicial extends CI_Controller
{
	...
	public function actualizar()
	{
		...
		$precio_unitario_actualizar = $this->input->post("precio_unitario_actualizar");
		$valor_total_actualizar = $this->input->post("valor_total_actualizar");
		...
		if ($id_dcarga_inicial_actualizar != "") {
			$this->actualizar_detalle($id_dcarga_inicial_actualizar, $item_actualizar, $precio_unitario_actualizar, $valor_total_actualizar);
		}
	...
	protected function actualizar_detalle($id_dcarga_inicial_actualizar, $item_actualizar, $precio_unitario_actualizar, $valor_total_actualizar)
	{
		for ($i = 0; $i < count($id_dcarga_inicial_actualizar); $i++) {
			$this->M_carga_inicial->actualizar_detalle(
				$id_dcarga_inicial_actualizar[$i],
				$item_actualizar[$i],
				$precio_unitario_actualizar[$i],
				$valor_total_actualizar[$i]
			);
		}
	}
