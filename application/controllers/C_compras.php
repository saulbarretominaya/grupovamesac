...
class C_compras extends CI_Controller
{
    ...
    //     $this->M_compras->insertar($id_compras, $id_trabajador, $fecha_emision_voucher, $fecha_vencimiento_voucher, $numero_serie,  $id_cliente_proveedor, $subtotal_factura, $igv_factura, $total_factura, $estado_compra, $observacion_pago, $codigo_pago_voucher, $voucher_pago, $fecha_pago_voucher, $tipo_cambio, $numero_letra_cheque, $importe_pago, $observacion_voucher, $estado_voucher, $total_deuda_voucher, $beneficiario_pago, $numero_deposito, $monto_pagado_voucher, $monto_pendiente_voucher, $tipo_comprobante, $mercaderia, $condicion_pago, $medio_pago, $moneda, $cta_ent, $transaccion, $banco, $medio_pago_voucher, $leyenda, $moneda_voucher);
